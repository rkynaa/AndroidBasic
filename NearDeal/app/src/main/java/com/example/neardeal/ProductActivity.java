...
import com.example.neardeal.fragment.DealListFragment;
import com.example.neardeal.fragment.ProductFragment;
...
public class ProductActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public SectionsPagerAdapter(FragmentManager fm) {
            ...
            String getStoreId = getIntent().getStringExtra("store_id");

            System.out.println(" Produc Ac Id : "+getStoreId);
            Bundle bundle = new Bundle();
            bundle.putString("store_id", getStoreId);
